            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-upload fa-sm text-white-50"></i> Registrar profesores</a>
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Profesores registrados</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        try {
                                            ...
                                            from persona inner join profesor on persona.cedulanit = profesor.cedula";
                                        ...
                                        while ($profesor = $resultado->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a id="eliminar" onclick="eliminarProfesor('<?php echo $profesor['cedulanit'] ?>')" class="btn btn-danger btn-icon-split">
                                                        <span class="icon text-white-50">
