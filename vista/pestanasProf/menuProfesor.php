<ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Perfil_profesor.php">
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="Convenio_evaluacion.php">
            <i class="fas fa-cloud-upload-alt"></i>
            <span>Subida de Convenio y Evaluaci&oacute;n </span>
        </a>
    </li>
    <!-- Nav Item - Charts -->
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="Historiales.php">
            ...
            <span>Historial de practicas</span>
        </a>
    </li>
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="Perfil_profesor.php">
