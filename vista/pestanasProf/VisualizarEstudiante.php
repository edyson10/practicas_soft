                                ...
                                <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        try {
                                            ...
                                            from persona inner join estudiante on persona.cedulanit = estudiante.cedula";
                                        ...
                                        while ($profesor = $resultado->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a id="informacion" onclick="verInformacionEstudiante('<?php echo $profesor['cedulanit'] ?>')" class="btn btn-info btn-icon-split" data-toggle="modal" data-target="#myModal">
